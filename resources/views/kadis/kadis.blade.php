            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                        ...
                        <tbody>  
                            @foreach (\App\Models\UserInformation::whereStatus(\App\Models\UserInformation::STATUS_KADIS)->orderBy('created_at')->get() as $item)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-sm bg-primary text-white" href="{{ route('kadis-detail', ['id' => $item->uuid]) }}">Detail</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody>
